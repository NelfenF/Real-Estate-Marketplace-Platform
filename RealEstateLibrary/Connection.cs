...
namespace RealEstateLibrary
{
    public class DBConnect
    {
        ...
        String SqlConnectString = "server=cis-mssql1.temple.edu;Database=fa24_3342_tur31103;User id=;Password=";
        
        //Home Connection String - used for working from home using SSH Tunneling.
        //String SqlConnectString = "server=127.0.0.1,5555;Database=fa24_3342_tur31103;User id=;Password=";
