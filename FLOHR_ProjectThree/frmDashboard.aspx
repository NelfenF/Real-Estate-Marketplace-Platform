        ...
        <div class="container-fluid" id="main" runat="server">
            <div class="row">
                <div class="col-md-3 col-lg-2 sidebar bg-light p-3" id="sideBar">
                    ...
                    <asp:Label ID="lblFilterOptionError" runat="server" CssClass="text-warning"></asp:Label>
                    <div class="filter-group mb-3">
                        ...
                        <asp:RadioButtonList ID="radlFilterPropertyType" runat="server" CssClass="form-control mb-3" RepeatDirection="Vertical" RepeatLayout="Flow" CellPadding="1" CellSpacing="1"></asp:RadioButtonList>
                        ...
                        <asp:CheckBoxList ID="chklFilterAmenities" runat="server" CssClass="form-check" CellSpacing="2" CellPadding="2">
                        </asp:CheckBoxList>
                    </div>
                ...
                <div class="col-md-9 col-lg-10 p-4" id="listingContent" runat="server">
                    ...
                    <div id="singleListing" runat="server">
                        <asp:ListView ID="lstvSingleListing" runat="server" ItemPlaceholderID="plhldLSingleListing" OnItemCommand="lstvSingleListing_ItemCommand" OnItemDataBound="lstvSingleListing_ItemDataBound">
                            ...
                            <ItemTemplate>
                                ...
                                <div class="row mb-4">
                                    <div id="carousel">
                                        <asp:Image ID="imgListingCurrentImage" runat="server" CssClass="d-block w-100" Height="500" />
                                        <div class="row" id="carouselControls">
                                            <div class="col">
                                                <asp:Button ID="btnPreviousImage" runat="server" Text="Previous Image" CssClass="btn btn-primary w-100" CommandName="previousImage" />
                                            </div>
                                            <div class="col">
                                                <asp:Button ID="btnNextImage" runat="server" Text="Next Image" CssClass="btn btn-primary w-100" CommandName="nextImage" />
                                            </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-12">
                                        ...
                                        <p>
                                            <asp:PlaceHolder ID="plhldListingAmenities" runat="server"></asp:PlaceHolder>
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div id="requestShowingArea" runat="server" visible="false" class="container my-4">
                        <asp:Label ID="lblShowingRequestError" runat="server" CssClass="text-danger"></asp:Label>
                        <div class="row">
                    ...
                    <div id="makeOfferArea" runat="server" visible="false" class="container my-4">
                        <asp:Label ID="lblOfferAreaError" runat="server" CssClass="text-danger"></asp:Label>
                        <div class="row mb-3">
                            <div class="col-md-6">
