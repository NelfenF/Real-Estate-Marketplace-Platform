...
<head runat="server">
    <title>Flohr - Agent Dashboard - Project 3</title>
        ...
        <div id="mainContent">
            ...
            <div id="newListing" runat="server">
                ...
                <div id="newListingFormArea" runat="server" visible="false">
                    <asp:Label ID="lblNewListingConfirmation" runat="server" CssClass="text-success"></asp:Label>
                    ...
                    <div class="row g-3 mt-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txtYearBuilt" runat="server" CssClass="form-control" MaxLength="4"></asp:TextBox>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row g-3 mt-3">
                        ...
                        <div class="col-md-12">
                            <asp:Label ID="lblNumberGarage" runat="server" CssClass="form-label" Text="Number Car Garage"></asp:Label>
                        ...
                        <div id="imageUpload" runat="server" class="mt-3" visible="false">
                            <div id="uploadArea" runat="server" visible="false" class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <br />
                                    <br />
                                    <asp:Label ID="lblUploadImage" runat="server" CssClass="form-label" Text="Upload Property Image (.png, .jpeg, .jpg, .gif)"></asp:Label>
                                ...
                                <asp:GridView ID="gvImages" runat="server" CssClass="table table-bordered mt-3" OnRowDeleting="gvImages_RowDeleting" AutoGenerateColumns="False">
                                    <Columns>
                                        <asp:BoundField DataField="FileName" HeaderText="Uploaded File Name" />
            ...
            <div id="viewListings" runat="server">
                <asp:Button ID="btnViewListings" runat="server" CssClass="btn btn-primary mb-3" Text="View Your Listings" OnClick="btnViewListings_Click" />
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <asp:Button ID="btnEditListing" runat="server" CssClass="btn btn-primary w-50 me-1" Text="View or Edit Listing" CommandName="viewEditListing" />
                                            <asp:Button ID="btnDeleteListing" runat="server" CssClass="btn btn-danger w-50 ms-1" Text="Delete Listing" CommandName="DeleteListing" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="viewEditListing" runat="server" visible="false">
                ...
                <div class="row g-3">
                    <div class="col-md">
                        <asp:Label ID="lblEditListingInfo" runat="server" CssClass="text-danger" Text="Select the edit button to start editing the listing. When finished click the save button!"></asp:Label>
                        <asp:Label ID="lblEditListingError" runat="server" CssClass="text-danger"></asp:Label><br />
                ...
                <div class="row g-3 mt-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:TextBox ID="txtEditZipCode" runat="server" CssClass="form-control" Enabled="False" MaxLength="5"></asp:TextBox>
                    </div>
                    <div class="col-md-4">
                        <asp:Label ID="lblEditYearBuilt" runat="server" CssClass="form-label" Text="Year Built: "></asp:Label>
                        <asp:TextBox ID="txtEditYearBuilt" runat="server" CssClass="form-control" Enabled="False" MaxLength="4"></asp:TextBox>
                    </div>
                </div>
                <div class="col-12">
                ...
                <div class="row g-3 mt-3">
                    <asp:Label ID="lblEditListingImageRoomInfo" runat="server" CssClass="text-danger" Text="Adding a new room or image is automatically saved but deleteing a room or image is not! To save a delation make sure to hit the save button!"></asp:Label>
                    <div class="col-md-6">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 d-flex flex-column">
                        ...
                        <div id="editImagesArea" runat="server" visible="false">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <asp:Label ID="lblEditImages" runat="server" CssClass="form-label" Text="Upload New Image (.png, .jpeg, .jpg, .gif)"></asp:Label>
